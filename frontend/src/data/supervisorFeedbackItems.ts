import type { FeedbackFilterValue, FeedbackType } from '../types/supervisorFeedback'
...
export const feedbackTypeBadgeConfig: Record<FeedbackType, FeedbackTypeBadgeConfig> = {
  idea: {
    label: 'ایده',
