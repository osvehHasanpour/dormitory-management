...
import navExit from '@media/nav-exit.jpg'
import navHome from '@media/nav-home.jpg'
import navProfile from '@media/nav-profile.jpg'
import navReport from '@media/nav-report.jpg'
