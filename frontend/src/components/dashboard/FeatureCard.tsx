...
export function FeatureCard({ label, image, route }: FeatureCardProps) {
  return (
    <Link
      to={route}
      className="flex min-h-[120px] flex-col items-center justify-center gap-2 rounded-md bg-canvas p-4 shadow-elevated transition-colors active:bg-primary/20 sm:min-h-[140px]"
    >
