...
export function ProfileAvatar({ imageUrl, alt }: ProfileAvatarProps) {
  return (
    <div className="relative mx-auto h-28 w-28 sm:h-32 sm:w-32">
      ...
      <button
        type="button"
        className="absolute bottom-0 left-0 flex h-9 w-9 items-center justify-center rounded-full border border-hairline bg-canvas text-ink shadow-elevated transition-colors active:bg-surface-card"
