...
export async function fetchSupervisorFeedback(
  ...
  try {
    const response = await apiClient.get<
      ApiSuccessResponse<SupervisorFeedbackListResponse>
    ...
    throw new Error(
      extractApiError(
        error,
        "دریافت لیست ایده‌ها و شکایات ناموفق بود. لطفاً دوباره تلاش کنید.",
      ),
      { cause: error },
    );
  }
...
export async function fetchSupervisorFeedbackDetail(
  ...
  try {
    const response = await apiClient.get<
      ApiSuccessResponse<SupervisorFeedbackItem>
...
export async function respondToFeedback(
  ...
  try {
    ...
    throw new Error(extractApiError(error, "ثبت پاسخ ناموفق بود."), {
      cause: error,
    });
  }
}
...
export async function rejectFeedback(
  ...
  try {
    ...
    throw new Error(extractApiError(error, "رد مورد ناموفق بود."), {
      cause: error,
    });
  }
}
...
export async function reviewIdea(
  ...
  try {
    ...
    throw new Error(extractApiError(error, "بررسی ایده ناموفق بود."), {
      cause: error,
    });
  }
}
